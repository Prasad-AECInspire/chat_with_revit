        ...
        <div className="relative w-full group/dropdown" ref={dropdownRef}>
            ...
            >
                <input
                    ...
                    readOnly={!isOpen}
                    className="w-full bg-zinc-900/50 hover:bg-zinc-900 border border-white/5 rounded-xl px-4 pr-10 py-2.5 text-xs text-zinc-100 placeholder-zinc-600 focus:outline-none focus:ring-2 focus:ring-cyan-500/30 transition-all cursor-pointer shadow-inner"
                />
                <div className="absolute right-3.5 pointer-events-none transition-transform duration-300">
                    <svg className={`w-3 h-3 text-zinc-500 transition-transform ${isOpen ? "rotate-180 text-cyan-500" : ""}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
